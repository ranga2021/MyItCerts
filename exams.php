        ...
        <div class="container-fluid">
            ...
            <div class="exams-content">
                ...
                <div class="exams-grid">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="Cisco CCNA">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="Microsoft Azure AI">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="CompTIA Security+">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="ISACA CISA">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="AWS Cloud Practitioner">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="Cisco CCNP">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="Microsoft Azure AI Fundamentals">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="ISACA CISM">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="Google Cloud">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="Salesforce AI">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="ECCouncil CEH">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="Palo Alto Networks">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
                    ...
                    <div class="exam-card">
                        <div class="exam-image">
                            <img src="images/exams/sample.png" alt="AWS Developer">
                            <div class="exam-label">Certification</div>
                        </div>
                        <div class="exam-content">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            examCards.forEach(card => {
                ...
                // AWS certifications
                if (/AWS|aws/i.test(title)) {
                    category = 'AWS';
                }
                // Cisco certifications
                else if (/Cisco|CCNA|CCNP/i.test(title)) {
                    category = 'Cisco';
                }
                // Microsoft certifications
                else if (/Microsoft|Azure|AI-/i.test(title)) {
                    category = 'Microsoft';
                }
                // CompTIA certifications
                else if (/CompTIA|A\+|Security\+/i.test(title)) {
                    category = 'CompTIA';
                }
                // ISACA certifications
                else if (/ISACA|CISA|CISM/i.test(title)) {
                    category = 'ISACA';
                }
                // Google certifications
                else if (/Google|Cloud Engineer/i.test(title)) {
                    category = 'Google';
                }
                // Salesforce certifications
                else if (/Salesforce/i.test(title)) {
                    category = 'Salesforce';
                }
                // ECCouncil certifications
                else if (/ECCouncil|CEH|312-/i.test(title)) {
                    category = 'ECCouncil';
                }
                // Palo Alto certifications
                else if (/Palo Alto|PCNSA/i.test(title)) {
                    category = 'Palo Alto';
                }
